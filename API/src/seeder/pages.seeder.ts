...
import { Pages } from "src/common/schema/pages.schema";

@Injectable()
export class PagesSeeder implements Seeder {

    constructor(@InjectModel(Pages.name) private readonly page: Model<Pages>) {}
    ...
    async seed(): Promise<any> {
        ...
        var json = [
        {
            ...
            '<p>Welcome to&nbsp;<strong>Photerra, Inc.</strong></p>'+
            
            '<p>Photerra, Inc.&nbsp;(&ldquo;us&rdquo;, &ldquo;we&rdquo;, or &ldquo;our&rdquo;) operates&nbsp;https://photerra.com/ and Photerra mobile application&nbsp;(hereinafter referred to as &ldquo;<strong>Service</strong>&rdquo;).</p>'+
            
            '<p>Our Privacy Policy governs your visit to&nbsp;https://photerra.com/ and Photerra mobile application, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>'+
            ...
            '<p><strong>SERVICE&nbsp;</strong>means the&nbsp;https://photerra.com/ website and Photerra mobile application&nbsp;operated by&nbsp;Photerra, Inc.</p>'+
            ...
            '<p>Photerra, Inc.&nbsp;uses the collected data for various purposes:</p>'+
            ...
            '<p>Photerra, Inc.&nbsp;will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>'+
            ...
            '<p>If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <a href="mailto:info@photerra.com">info@photerra.com</a>.</p>'+
            ...
            '<ul>'+
                ...
                '<li>users are able to change their personal information by emailing us at <a href="mailto:info@photerra.com">info@photerra.com</a>.</li>'+
            '</ul>'+
            ...
            '<p>By email: <a href="mailto:info@photerra.com">info@photerra.com</a></p>'+
            
            '<p>By mail: 133 Baker St. Apt. 10, San Francisco, CA 94117</p>'+
            ...
            '<p>Photerra, Inc.&nbsp;uses remarketing services to advertise on third party websites to you after you visited our Service. We and our third-party vendors use cookies to inform, optimise and serve ads based on your past visits to our Service.</p>'+
        ...
        },
        {
            ...
            content: '<p><strong>TERMS OF SERVICE</strong><strong>&nbsp;</strong></p>'+

            '<p>Last updated:&nbsp;11/01/2021</p>'+
            ...
            '<ol>'+
                '<li><strong>Fee Changes</strong></li>'+
            '</ol>'+
        ...
        },
        {
            name: "Pangi",
            slug:"pangi",
            content: "Url of Logo image for project",
        }
    ];
    
        // Insert into the database.
        return await this.page.insertMany(json);
    }

    async drop(): Promise<any> {
        return await this.page.deleteMany({});
    }
}